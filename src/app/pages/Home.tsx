  ...
  return (
    <div className="pt-20 bg-gradient-to-b from-[#0A0A0F] via-[#12121A] to-[#0A0A0F]">
      ...
      <Hero
        ...
        subtitle="Testing 1 - Join me as I discover breathtaking destinations, immerse myself in diverse cultures, and share unforgettable adventures from around the globe."
        overlay="dark"
      >
