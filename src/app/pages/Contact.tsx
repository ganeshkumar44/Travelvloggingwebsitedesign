  ...
  const faqs = [
    {
      ...
      answer:
        "You can view all upcoming group tours on the Events page. Simply click on the tour you're interested in and follow the booking process. Spaces are limited, so book early!",
    },
    {
      question: "Do you offer travel consulting services?",
      answer:
        "Yes! I offer personalized travel consulting where I can help you plan your itinerary, provide destination recommendations, and share insider tips. Contact me for rates and availability.",
    },
    {
      question: "Can I use your photos/videos for my project?",
      answer:
        "Please reach out via the contact form with details about your project. I'm happy to discuss licensing and permissions on a case-by-case basis.",
    },
    {
      question: "How do I collaborate with you?",
      answer:
        "I'm always open to collaboration opportunities! Send me an email with details about your proposal, brand, or project. I typically respond within 3-5 business days.",
    },
    {
      question: "Do you accept sponsorships?",
      answer:
        "Yes, I work with select brands that align with my values and audience. Please send partnership inquiries to hello@wanderlust.com with your proposal.",
    },
    {
      question: "Where are you traveling next?",
      answer:
        "Check the Events page for upcoming destinations! I also share travel updates on my social media channels, so make sure to follow me there.",
    },
  ];
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label
                      htmlFor="name"
                      className="block mb-2 text-[var(--gray-dark)]"
                    >
                      Your Name *
                    </label>
                    <input
        ...
        >
          <div className="bg-[var(--muted)] h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--gray-medium)] mt-2">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map((faq, index) => (
              ...
              >
                <h4 className="text-lg mb-3 text-[var(--primary)]">
                  {faq.question}
                </h4>
      ...
      <Section background="dark">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Get exclusive travel tips, destination guides, and
            behind-the-scenes content delivered straight to your
            inbox.
          </p>
          ...
          <p className="text-sm text-gray-400 mt-4">
            No spam, unsubscribe anytime. I respect your
            privacy.
          </p>
        </div>
      </Section>
